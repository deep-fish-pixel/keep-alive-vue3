...
You can use [vite-app-pro](https://github.com/deep-fish-pixel/create-vite-app) cli to create template project，keep-alive-vue3 was built in project，convenient experience and use。
